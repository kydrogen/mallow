...
PREDEFINED_ARTIFACTS = [
	{
		...
		"description": """The The Narmer Palette artifact is an oval-shaped, deeply polished lens of 
	...
	},
	{
		...
		"description": """The Rosetta Stone artifact is a rectangular slab of
	...
	{
		"name": "The Alpine Light-Diffusion Prism (Accession A-2097-EP)",
		"description": """The Alpine Light-Diffusion Prism artifact is a masterfully 
		crafted prism oftranslucent quartzite,measuring 14.2 cm at its base,
