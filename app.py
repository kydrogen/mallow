...
with col1:
	def on_text_submit():
		"""Callback triggered when Enter is pressed in the text input."""
	...
	user_question = st.text_input(
		...
		key="agent_question_input", on_change=on_text_submit)
